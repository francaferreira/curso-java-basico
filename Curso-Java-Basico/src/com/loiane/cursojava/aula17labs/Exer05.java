		 ...
		 Scanner scan = new Scanner(System.in); {
				...
				do {
					...
					if (popA > 0) {
						...
						System.out.println("População A precisar ser maior do 0.");
					}
				...
				do {
					...
					if (popB > 0 ) {
						...
						System.out.println("População B precisar ser maior do 0.");
					}
				...
				System.out.println("Populalação A: " + popA);
				System.out.println("Populalação B: " + popB);
